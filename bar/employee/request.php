        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Requests Record</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              $sl="select * from appoint where status!='scheduled' and status!='Declined' and appoffice_ID='$officeID' ";
                    $res=mysqli_query($conn,$sl);
                    while($row=mysqli_fetch_assoc($res)){
                       $id=$row["id"];
                      $name=$row["app_name"];
                       $email=$row["app_email"];
                        $idnum=$row["app_IDNUMBER"];
                         ...
                         <?php }
                           ...
                           <td>
                             <button onclick="sendme('<?php echo $id?>,<?php echo $email?>')" class="btn btn-success" title="Appointment Schedule Now?"><i class="fa fa-reply"></i></button>
                           

                            <button onclick="declineme('<?php echo $id?>,<?php echo $email?>')" class="btn btn-danger" title="Decline"><i class="fa fa-times"></i> </button>
                             <button onclick="commentme('<?php echo $id?>,<?php echo $email?>')" class="btn btn-warning" title="Comment"><i class="fa fa-comment"></i> </button>
                           </td>
