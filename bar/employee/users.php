...
function office($conn){
  $r="";
  $sl="select * from offices";
  $res=mysqli_query($conn,$sl);
  while($row=mysqli_fetch_assoc($res)){
    $r.="<option value=".$row['id'].">".$row['office_name']."</option>";
  }
  return $r;
}     
?>
            ...
            <div class="col-lg-4">
              ...
              if(isset($_POST["create"])){
                ...
                if($cnt==1){ ?>
                  ...
                  <div class="alert alter-danger">Email is already in use.</div>

              <?php  }else{ 

                  $ins="insert into users(user_email,user_pass,user_name,useroffice_ID) values('$email','$pass','$name','$offid')";
